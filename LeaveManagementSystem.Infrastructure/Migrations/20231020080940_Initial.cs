    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8164ba91-22d1-4962-89c7-f78fbd4bb2f8"), "Emergency leave" });

            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "LeaveTypeID", "LeaveTypeName" },
                values: new object[] { new Guid("ac08bd94-5d63-4cb5-bd7f-056b66f0c275"), "Annual leave" });

            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "LeaveTypeID", "LeaveTypeName" },
                values: new object[] { new Guid("c05e2b7f-8574-4b5b-b515-5f57a9faebe9"), "Sick leave" });
